...
SSE.prototype.init = function(config) {
    ...
    gooseOpt.server.poolSize = gooseOpt.server.poolSize || 2;
    ...
    this.db = mongoose.createConnection(oplogConnectionString, gooseOpt);
...
SSE.prototype.getQuery = function(req) {
