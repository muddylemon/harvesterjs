...
/**
 * Transform harvest schema into a schema or model of the underlying adapter. Although this method is actually called from another module, it should not be called manually, so it is marked as private.
 *
 * @api private
 * @param {String} name the name of the resource
 * @param {Object} schema an object in the Harvest schema format
 ...
 * @param {Number} [offset] skip a number of resources to send back. Default: 0
 * @param {Object} [sort] sort the resources to send back. Default: {"_id":-1}
